    ...
    <div id="wrapper">
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="ehs_em/"><i class="fa fa-desktop fa-3x"></i>IT Support</a>
                    </li>				
                </ul>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Form PAMIT Support Sheet</h2>   
                        <h5>PT XYZ</h5>
			   ...
			   <div class="col-md-6 col-sm-6">
                        ...
                        <div class="panel-body">
									<p> <div class="form-group">
                                        ...
                                        <div class="form-group">
											...
											if(!empty($e['gambar1']))
											{
												echo "<img src='ehs_em/gambar1/$e[gambar1]' width=200 height=200 >";
											}
											else {
												
												echo "<img src='ehs_em/gambar2/No_Image_Available.png' width=200 height=200 >"; 
											}
											?>
                        ...
                        <div class="panel-body">
									<p><div class="form-group">
                                        ...
                                        <div class="form-group">
											...
											if(!empty($e['gambar2']))
											{
												echo "<img src='ehs_em/gambar2/$e[gambar2]' width=200 height=200 >";
											}
											else {
				...
				<a href="ehs_em/print.php?id=<?php echo $e['id'] ?>" class="btn btn-success" > Cetak </a>
			</div>
			</div>

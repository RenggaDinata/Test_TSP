						...
						<?php
							...
							<style>
							 ...
							 <div class="table-responsive">
								...
								<form action="input_user.php" method="POST" name="input" >
								<table cellpadding="4" cellspacing="1" border="0" width="350">
								<tr>
								<td>Username</td>
								<td> : <input type="text" name="username" size="50" maxlength="20" /></td></tr>
								<tr>
								<td>Password</td>
								<td> : <input  type="password" name="password" size="50" maxlength="20"/></td>
								</tr>
								<tr>
								<td>Nama</td>

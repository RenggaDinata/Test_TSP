           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
					...
					<li>
                        <a class="active-menu" href="user-view-list.php"><i class="fa fa-desktop fa-3x"></i>Lihat Semua Data</a>
                    </li>
                     <li>
									...
									<tbody>
										...
										?>
												<tr>
													...
													<td align="center">
														<a href="user-view.php?id=<?php echo $b['id'] ?>" class="btn btn-info">Lihat </a>

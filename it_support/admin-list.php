									...
									<tbody>
										...
										?>
												<tr>
													...
													<td align="center">
														<a href="admin-edit.php?id=<?php echo $b['id'] ?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Ubah</button></a>
														<a href="admin-hapus.php?id=<?php echo $b['id'] ?>" onclick="return confirm('Are you sure to DELETE this record ?')"><button class="btn btn-danger"><i class="fa fa-pencil"></i> Hapus</button></a>

                        ...
                        <div class="panel-body">
                            <div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
                                            <label>PIC</label>
											<input class="form-control" type="text" name="nama_pic" <?php echo "value='$e[nama]'"; ?> placeholder="Please insert PIC name" required readonly />
                                            <input class="form-control" type="hidden" name="pic" <?php echo "value='$e[pic]'"; ?> placeholder="Please insert PIC name" required readonly />
                                     </div>
									 <div class="form-group">
                                            <label>Status</label>
			   ...
			   <div class="col-md-6 col-sm-6">
				...
				<div class="col-md-6">
					<div class="form-group">
											...
											<input class="form-control"  <?php echo "value='$e[verify]'"; ?>  type="text" id="verify" name="verify" readonly />
											<!--?php
